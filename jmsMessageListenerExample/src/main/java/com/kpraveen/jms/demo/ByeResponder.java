    ...
    public static void main(String... args) throws Exception {
		...
		try {
			...
			do {
				...
				String replyPayload = String.format("Bye, %s", requestMessage.getText());
				String activity = requestMessage.getJMSCorrelationID();

				if (activity.equals("SayBye")) {

					replyPayload = String.format("Bye, %s", requestMessage.getText());
				}
